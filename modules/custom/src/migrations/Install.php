...
class Install extends Migration
{
    ...
    // custom_customrecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%custom_customrecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%custom_customrecord}}',
    ...
    // custom_customrecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%custom_customrecord}}', 'siteId'),
            '{{%custom_customrecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // custom_customrecord table
        $this->dropTableIfExists('{{%custom_customrecord}}');
    }
}
